...
skin.name = "Snap"
skin.author = "unek.czarnawol.ga, Edited by: RamiLego4Game"
skin.version = "1.1"
skin.base = "Blue"
...
-- fonts
local smallfont     = love.graphics.newFont(path .. "/font/Roboto-Light.ttf", 12)
local boldfont      = love.graphics.newFont(path .. "/font/RobotoCondensed-Bold.ttf", 12)
...
-- collapsiblecategory
skin.controls.collapsiblecategory_text_color        = whitecolor
...
function skin.DrawButton(object)
    ...
    if not enabled or not clickable then
        -- button body
        love.graphics.setColor(bodynonclickablecolor)
        love.graphics.rectangle("fill", x, y+radius, width, height)
        -- button text
        love.graphics.setFont(font)
