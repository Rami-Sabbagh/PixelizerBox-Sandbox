...
local path = string.sub(..., 1, string.len(...) - string.len(".skins.SSH.skin"))
...
local nohoverBlue = {0,255,0,255}
local hoverBlue = {0,150,0,255}
local downBlue = {0,100,0,255}
local liteBlue = {0,75,0,255}
local flatGray = {0,75,0,255}
...
-- frame
skin.controls.frame_body_color                      = {0,50,0,255}
skin.controls.frame_name_color                      = {0,50,0,255}
skin.controls.frame_name_font                       = smallfont

-- button
skin.controls.button_text_down_color                = {0, 50, 0, 255}
skin.controls.button_text_nohover_color             = {0, 50, 0, 255}
skin.controls.button_text_hover_color               = {0, 50, 0, 255}
skin.controls.button_text_nonclickable_color        = {0, 50, 0, 255}
skin.controls.button_text_font                      = smallfont

-- imagebutton
skin.controls.imagebutton_text_down_color           = {0, 150, 0, 255}
skin.controls.imagebutton_text_nohover_color        = {0, 255, 0, 255}
skin.controls.imagebutton_text_hover_color          = {0, 200, 0, 255}
...
-- progressbar
skin.controls.progressbar_body_color                = {0, 50, 0, 255}
skin.controls.progressbar_text_color                = {0, 255, 0, 255}
skin.controls.progressbar_text_font                 = smallfont

-- list
skin.controls.list_body_color                       = {0, 50, 0, 255}

-- scrollarea
skin.controls.scrollarea_body_color                 = {0, 50, 0, 255}

-- scrollbody
skin.controls.scrollbody_body_color                 = {0, 50, 0, 0}

-- panel
skin.controls.panel_body_color                      = {0, 50, 0, 255}

-- tabpanel
skin.controls.tabpanel_body_color                   = {0, 50, 0, 255}

-- tabbutton
skin.controls.tab_text_nohover_color                = {0, 50, 0, 200}
skin.controls.tab_text_hover_color                  = {0, 255, 0, 255}
skin.controls.tab_text_font                         = smallfont

-- multichoice
skin.controls.multichoice_body_color                = {0, 50, 0, 255}
skin.controls.multichoice_text_color                = {0, 255, 0, 255}
skin.controls.multichoice_text_font                 = smallfont

-- multichoicelist
skin.controls.multichoicelist_body_color            = {0, 50, 0, 255}

-- multichoicerow
skin.controls.multichoicerow_body_nohover_color     = {0, 50, 0, 255}
skin.controls.multichoicerow_body_hover_color       = {0, 255, 0, 255}
skin.controls.multichoicerow_text_nohover_color     = {0, 255, 0, 255}
skin.controls.multichoicerow_text_hover_color       = {0, 50, 0, 255}
skin.controls.multichoicerow_text_font              = smallfont

-- tooltip
skin.controls.tooltip_body_color                    = {0, 50, 0, 255}

-- textinput
skin.controls.textinput_body_color                  = {0, 50, 0, 255}
skin.controls.textinput_indicator_color             = {0, 255, 0, 255}
skin.controls.textinput_text_normal_color           = {0, 255, 0, 255}
skin.controls.textinput_text_placeholder_color      = {0, 150, 0, 255}
skin.controls.textinput_text_selected_color         = {0, 255, 0, 255}
skin.controls.textinput_highlight_bar_color         = {0, 255, 0, 255}

-- slider
skin.controls.slider_bar_outline_color              = {0, 100, 0, 255}

-- checkbox
skin.controls.checkbox_body_color                   = {0, 50, 0, 255}
skin.controls.checkbox_check_color                  = {0, 255, 0, 255}
skin.controls.checkbox_text_font                    = smallfont

-- radiobutton
skin.controls.radiobutton_body_color                = {0, 50, 0, 255}
skin.controls.radiobutton_check_color               = {0, 255, 0, 255}
skin.controls.radiobutton_inner_border_color        = {0, 200, 0, 255}
skin.controls.radiobutton_text_font                 = smallfont

-- collapsiblecategory
skin.controls.collapsiblecategory_text_color        = {0, 50, 0, 255}

-- columnlist
skin.controls.columnlist_body_color                 = {0, 50, 0, 255}

-- columlistarea
skin.controls.columnlistarea_body_color             = {0, 50, 0, 255}

-- columnlistheader
skin.controls.columnlistheader_text_down_color      = {0, 255, 0, 255}
skin.controls.columnlistheader_text_nohover_color   = {0, 50, 0, 255}
skin.controls.columnlistheader_text_hover_color     = {0, 255, 0, 255}
skin.controls.columnlistheader_text_font            = smallfont

-- columnlistrow
skin.controls.columnlistrow_body1_color             = {0, 40, 0, 255}
skin.controls.columnlistrow_body2_color             = {0, 50, 0, 255}
skin.controls.columnlistrow_body_selected_color     = {0, 255, 0, 255}
skin.controls.columnlistrow_body_hover_color        = {0, 200, 0, 255}
skin.controls.columnlistrow_text_color              = {0, 255, 0, 255}
skin.controls.columnlistrow_text_hover_color        = {0, 50, 0, 255}
skin.controls.columnlistrow_text_selected_color     = {0, 50, 0, 255}

-- modalbackground
skin.controls.modalbackground_body_color            = {0, 50, 0, 100}

-- linenumberspanel
skin.controls.linenumberspanel_text_color           = {0, 50, 0, 255}
skin.controls.linenumberspanel_body_color           = {235, 235, 235, 255}

-- grid
skin.controls.grid_body_color                       = {0, 50, 0, 255}
...
-- menu
skin.controls.menu_body_color                       = {0, 50, 0, 255}

-- menuoption
skin.controls.menuoption_body_hover_color           = {0, 255, 0, 255}
skin.controls.menuoption_text_hover_color           = {0, 50, 0, 255}
skin.controls.menuoption_text_color                 = {0, 255, 0, 255}
...
function skin.DrawFrame(object)
	...
	-- frame top bar
	love.graphics.setColor(nohoverBlue)
...
function skin.DrawButton(object)
	...
	if not enabled or not clickable then
		-- button body
		love.graphics.setColor(flatGray)
		love.graphics.rectangle("fill", x, y, width, height)
		-- button text
		love.graphics.setFont(font)
	...
	if down then
		-- button body
		love.graphics.setColor(downBlue)
    love.graphics.rectangle("fill", x, y, width, height)
		-- button text
		love.graphics.setFont(font)
	...
	elseif hover then
		-- button body
		love.graphics.setColor(hoverBlue)
    love.graphics.rectangle("fill", x, y, width, height)
		-- button text
		love.graphics.setFont(font)
...
function skin.DrawScrollArea(object)
	...
	love.graphics.setColor(liteBlue)
	love.graphics.rectangle("fill", x, y, width, height)	
end
...
function skin.DrawLineNumbersPanel(object)
	...
	love.graphics.setColor(nohoverBlue)--bodycolor)
	love.graphics.rectangle("fill", x, y, width, height)
